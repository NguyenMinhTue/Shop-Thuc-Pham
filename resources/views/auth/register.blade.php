                           ...
                           <div class="card-body">
                               <form method="POST" action="{{ route('register') }}">
                                   ...
                                   <div class="form-group row">
                                       <label style="color:white" for="name" class="col-md-4 col-form-label text-md-right">{{ __('Full name') }}</label>
                                   ...
                                   <div class="form-group row">
                                       <label style="color:white" for="email" class="col-md-4 col-form-label text-md-right">{{ __('Email') }}</label>
