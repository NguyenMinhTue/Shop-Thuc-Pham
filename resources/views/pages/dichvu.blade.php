...
@section('title-page')
    <div class="products-breadcrumb">
        <div class="container">
            <ul>
                <li><i class="fa fa-home" aria-hidden="true"></i><a href="../../../public/index.php">Home</a><span>|</span></li>
                <li>Dịch vụ</li>
            </ul>
        </div>
    </div>
    ...
    <div class="services">
        ...
        <div class="w3ls_service_grids">
            ...
            <div class="col-md-7 w3ls_service_grid_right">
                <div class="col-md-4 w3ls_service_grid_right_1">
                    <img src="{{URL::to('public/images/18.jpg')}}" alt=" " class="img-responsive" />
                </div>
                <div class="col-md-4 w3ls_service_grid_right_1">
                    <img src="{{URL::to('public/images/19.jpg')}}" alt=" " class="img-responsive" />
                </div>
                <div class="col-md-4 w3ls_service_grid_right_1">
                    <img src="{{URL::to('public/images/20.jpg')}}" alt=" " class="img-responsive" />
                </div>
        ...
        <div class="w3ls_service_grids1">
            <div class="col-md-6 w3ls_service_grids1_left">
                <img src="{{URL::to('public/images/4.jpg')}}" alt=" " class="img-responsive" />
            </div>
            <div class="col-md-6 w3ls_service_grids1_right">
                ...
                <a href="{{URL::to('chitietsanpham')}}">Shop Now</a>
            </div>
            <div class="clearfix"> </div>
        </div>
    </div>
